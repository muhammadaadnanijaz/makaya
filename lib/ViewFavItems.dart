...
class ViewFav  extends State<ViewFavItems > {
  ...
  String getNewLineString(String readLines) {
    ...
    if(readLines.length>35)
      readLines = readLines.substring(0,35);
  ...
  Widget myDetailsContainer1(int i) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        //        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  ...
                  Column(children: <Widget>[
                    Container(margin:EdgeInsets.only(left: 0.0),
                        child: Text( getNewLineString(MyApp.witems[i].title.toString())+"....",maxLines: 10,style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),)
                    ),
        ...
        Container(padding:EdgeInsets.only(top:30.0 ) ,child: Text("Merchant:"+  MyApp.witems[i].merchant.toString(),
          style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),)),
        Container(padding:EdgeInsets.only(top:30.0 ) ,child: Text("Price:"+MyApp.witems[i].price,
          style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),)),
                ...
                new ButtonTheme(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed:()
                    {
                      ...
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => WebViewAmazon(MyApp.witems[i].url)));
                    },
                  ),
                ),
                new Container(margin: EdgeInsets.only(left: 80),),
            new Container(
  ...
  Widget build(BuildContext context) {
    ...
    final totalItems = Text(
        'Total Items=' +MyApp.witems.length.toString(),
        style: TextStyle(
            color: Colors.grey[800],
            fontWeight: FontWeight.bold,
            fontSize: 20));
        ...
        body: new Column(
            ...
            children: <Widget>[
              new ButtonTheme(
                ...
                child: FlatButton(
                  color:Colors.red,
                  child: Text("No Items added to wishlist.Want to add items at wishlist?",
                    style: TextStyle(
