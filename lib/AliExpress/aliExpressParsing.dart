...
//        }
    //For title
        print('Title Tag is ${document.getElementsByClassName("product-title-text")}');
        var titleTag = document.getElementsByClassName("product-title-text");

        print('Title is : $titleTag');

        this.title = titleTag[0].attributes['h1'];
