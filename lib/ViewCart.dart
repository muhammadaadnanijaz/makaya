...
class ViewCart extends State<ViewCartItems> {
  ...
  Widget myDetailsContainer1(int i) {
                ...
                children: <Widget>[
                  ...
                  Column(children: <Widget>[
                    Container(
                        ...
                        child: Text( getNewLineString(MyApp.aitems[i].title.toString())+"....",maxLines: 10,style: TextStyle(color: Colors.black, fontSize: 40.0,fontWeight: FontWeight.normal),)
   ...
   // color:MyApp.primarycolor,
    ...
    right: BorderSide(color: MyApp.primarycolor,style: BorderStyle.solid)
            ...
            margin: EdgeInsets.only(left: 20,right: 20),
                ...
                child: Text(MyApp.aitems[i].quantity.toString(),
              style: TextStyle(color: Color(0XFF2B567E), fontSize: 40.0,fontWeight: FontWeight.bold),)),
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: MyApp.primarycolor,
                border: Border(
                    ...
                    top:BorderSide.none,
                    bottom: BorderSide.none,
                    left: BorderSide(color: MyApp.primarycolor,style: BorderStyle.solid)
        ...
        Container(padding:EdgeInsets.only(top:30.0 ) ,child: Text("Merchant:"+  MyApp.aitems[i].merchant.toString(),
          style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),)),
        Container(padding:EdgeInsets.only(top:30.0 ) ,child: Text("Price:"+MyApp.aitems[i].price.replaceAll("\$", "USD:"),
          style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),)),
            ...
            child:Row(
              ...
              children: <Widget>[
                ...
                new ButtonTheme(
                  ...
                  child: RaisedButton(
                    child: Text(
                      "View", style: TextStyle(color: Colors.white, fontSize: 30.0),),
                    color: MyApp.primarycolor,
                    onPressed:()
                    {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => WebViewAmazon(MyApp.aitems[i].url)));
                    },
                  ),
                ),
                new Container(
                ...
                new ButtonTheme(
                  ...
                  child: RaisedButton(
                    child: Text(
                      "Remove", style: TextStyle(color: MyApp.primarycolor, fontSize: 30.0),),
                    color: Colors.white,
                    onPressed:()
                    {
                      Alert(
                        ...
                        title: "Remove Item",
                        desc: "Are you you want to remove item from wishlist?",
                        buttons: [
                          DialogButton(
                            child: Text(
                              "Yes",
  ...
  String getNewLineString(String readLines) {
    ...
    if(readLines.length>30)
      readLines = readLines.substring(0,30);
  ...
  Widget showData(String key,String value){
   ...
   // print("lanti -> "+value+" "+key);
    ...
    if(value == "" || value==null){
      ...
      return  Container(padding:EdgeInsets.only(top:30.0 ) ,child: Text(key+value,
        style: TextStyle(color: Colors.black, fontSize: 30.0,fontWeight: FontWeight.normal),));;
  ...
  Widget build(BuildContext context) {
    ...
    final checkOutButton = new ButtonTheme(
      ...
      child: RaisedButton(
        child: Text(
          "Checkout", style: TextStyle(color: Colors.white, fontSize: 20.0),),
        color: MyApp.primarycolor,
    ...
    final totalItems = Text(
        'Total Items=' + MyApp.aitems.length.toString(),
        style: TextStyle(
            color: Colors.grey[800],
            fontWeight: FontWeight.bold,
            fontSize: 20));
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => WebViewAmazon("http://www.amazon.com/")));
                  },
